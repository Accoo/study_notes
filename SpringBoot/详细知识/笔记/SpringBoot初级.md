...
打包方法：IDEA点击左下角按钮，让其显示右侧导航栏，点击Maven Project，选择lifecycle，双击package，打包后放在target文件夹内
...
**<u>Spring Boot将所有的功能场景都抽取出来，做成一个个的starters（启动器），只需要在项目里面引入这些starter相关场景的所有依赖都会导入进来。要用什么功能就导入什么场景的启动器</u>**
...
​      	@**<u>AutoConfigurationPackage</u>**：自动配置包
...
docker run -p 3306:3306 --name some-mysql -e MYSQL_ROOT_PASSWORD=my-secret-pw -d mysql:tag --character-set-server=utf8mb4 --collation-server=utf8mb4_unicode_ci
指定mysql的一些配置参数
```
